...
<body>
	<div class="container" style="margin-top: 20px;">
		<form class="form-horizontal" action="${basePath}query.cnbi"method="post">
			<fieldset>
				...
				<div id="legend" class="">
				 ...
				 <div class="form-group">
					  ...
					  <div class="form-group">
					   ...
					   <div class="form-group">
					    <label for="year" class="col-sm-2 control-label">请输入正确的SQL语句：</label>
					    <div class="col-sm-10">
					      <textarea name="sql" class=""style="margin: 0px; width: 100%; height: 150px;" placeholder="请输入正确语法的SQL语句!" required autofocus>
					        <c:if test="${sql != null}" var="visits">
							    ${sql}
							</c:if>
					      </textarea>
					    </div>
					  ...
					  <div class="form-group">
					    <div class="col-sm-offset-2 col-sm-10">
					      ...
					      <button type="reset" style="margin-left:30px;"class="btn btn-danger">重置清空</button>
					    </div>
					  </div>
			</fieldset>
		</form>
